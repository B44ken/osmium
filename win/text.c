...
void init_fonts(TTF_Font* ui_font, TTF_Font* editor_font, SDL_Renderer* renderer) {
    TTF_Init();
...
void draw_text(char* message, SDL_Rect pos, SDL_Color color) {
    TTF_Font* font = make_font("/usr/share/fonts/truetype/noto/NotoSansMono-Regular.ttf", 12);
