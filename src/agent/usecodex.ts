...
export class ChatGPTClient {
    ...
    private constructor(transport: AppServerTransport, defaultCwd: string, defaultModel?: string, approvalPolicy: ApprovalPolicy = 'never', sandbox: SandboxMode = 'danger-full-access') {
    ...
    static async create(options: ChatGPTClientOptions = {}): Promise<ChatGPTClient> {
        ...
        const clientInfo = options.clientInfo ?? { name: 'osmium', title: 'Osmium', version: '0.1.0' }
...
export type CodexPlan = ChatGPTPlan
export type CodexTurnStatus = ChatGPTTurnStatus
export type CodexReasoningEffort = ChatGPTReasoningEffort
export type CodexInputItem = ChatGPTInputItem
export type CodexInput = ChatGPTInput
export type CodexThreadItem = ChatGPTThreadItem
export type CodexTurnResult = ChatGPTTurnResult
export type CodexStreamEvent = ChatGPTStreamEvent
export type CodexModelOption = ChatGPTModelOption
export type CodexRecentThread = ChatGPTRecentThread
export type CodexThreadSnapshot = ChatGPTThreadSnapshot
export type CodexClientOptions = ChatGPTClientOptions
export type CodexRunOptions = ChatGPTRunOptions
export const CodexClient = ChatGPTClient
